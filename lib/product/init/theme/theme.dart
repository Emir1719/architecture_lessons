...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff87655a),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff40360a),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff796d3c),
      ...
      secondaryFixed: Color(0xff87655a),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff6c4d43),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff796d3c),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff604238),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff604238),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xfffff0be),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffd2c28a),
